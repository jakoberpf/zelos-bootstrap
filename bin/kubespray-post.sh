...
vault kv put CICD/repo/zelos-bootstrap/live/kube-secret admin_conf=$vault_admin_config_base64 | grep "create_time"
...
oci os object put --profile=KUBESPRAY -ns "$oci_namespace" -bn zelos --name kubespray/admin.live.conf --file $config_file --force
